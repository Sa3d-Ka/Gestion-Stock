    ...
    <div>
      ...
      <div className="p-6 border border-gray-200 shadow-lg rounded-2xl mt-6 bg-white space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="px-4 py-2 flex items-center gap-2 bg-linear-to-br from-blue-600 to-blue-700 text-sm text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 cursor-pointer shadow-lg">
